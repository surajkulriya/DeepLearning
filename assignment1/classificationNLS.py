...
if(__name__=="__main__"):
    ...
    # p0.train(X_train, y_train, y_train_int, 0.1, 0, X_test, y_test, X_valid, y_valid, 200, "non Linearly seprable")    
    ...
    # p1.train(X_train, y_train, y_train_int, 0.1, 0, X_test, y_test, X_valid, y_valid, 200, "non-Linearly")
    ...
    p2.train(X_train, y_train, y_train_int, 0.1, 0, X_test, y_test, X_valid, y_valid, 200, "non-Linearly")
