...
if (__name__=="__main__"):
    ...
    # p0.train(X_train, y_train, y_train, 0.01, 0, X_test, y_test, X_valid, y_valid, 0.0000001, 10, "univariate")
    ...
    # p1.train(X_train, y_train, y_train, 0.1, 0, X_test, y_test, X_valid, y_valid, 0.000001, 200, "univariate")
    ...
    p2.train(X_train, y_train, y_train, 0.1, 0, X_test, y_test, X_valid, y_valid, 0.0000001, 200, "univariate")
