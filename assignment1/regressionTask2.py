...
if (__name__=="__main__"):
    ...
    # p0.train(X_train, y_train, y_train, 0.1, 0, X_test, y_test, X_valid, y_valid, 0.0000001, 100, "2 variate")
    ...
    p1.train(X_train, y_train, y_train, 0.1, 0, X_test, y_test, X_valid, y_valid, 0.00001, 100, "2 variate")
